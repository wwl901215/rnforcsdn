...
package com.rn_csdn.rn.webview;
...
import com.rn_csdn.rn.webview.events.ProgressEvent;
import com.rn_csdn.rn.webview.events.TopLoadingErrorEvent;
import com.rn_csdn.rn.webview.events.TopLoadingFinishEvent;
import com.rn_csdn.rn.webview.events.TopLoadingStartEvent;
import com.rn_csdn.rn.webview.events.TopMessageEvent;
...
public class ReactWebViewManager extends SimpleViewManager<WebView> {
  ...
  /**
   * Progress:ProgressEvent中的EVENT_NAME;
   * registrationName:表明将Progress绑定到js中的onProgress,即CusWebView中的NativeWebView中的onProgress属性;
   * @return
   */
  @Nullable
  @Override
  public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
    return MapBuilder.<String, Object>builder()
            .put("Progress",MapBuilder.of("registrationName", "onProgress"))
            .build();
